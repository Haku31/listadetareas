...
const TodoItems = () => {
  ...
  if (items.length == 0) {
    return <div className="text-blue-200 font-bold text-xl">Lista vacia...</div>
  }
  else if (filtered.length == 0 && filterMode == "Active") {
    return <div className="text-blue-200 font-bold text-xl">No hay tareas incompletas</div>
  }
  else if (filtered.length == 0 && filterMode == "Completed") {
    return <div className="text-blue-200 font-bold text-xl">No hay tareas Completadas</div>
  }
  return (
    <>
